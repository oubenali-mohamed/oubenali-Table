...
function TableEmployee(_ref) {
  ...
  var _useState5 = (0, _react.useState)(10),
    ...
    employesPerPage = _useState6[0];
  var _useState7 = (0, _react.useState)([]),
    _useState8 = (0, _slicedToArray2.default)(_useState7, 2),
    currentEmployes = _useState8[0],
    setCurrentEmployes = _useState8[1];
  ...
  var employes = currentEmployes.slice(firstEmployeIndex, lastEmployeIndex);
  var filtreEmployee = function filtreEmployee(e) {
    var value = e.target.value;
    setSearchLetter(value);
    setCurrentEmployes((0, _toConsumableArray2.default)(employes.filter(function (employee) {
  ...
  }))), /*#__PURE__*/_react.default.createElement("tbody", null, employes.map(function (row, index) {
